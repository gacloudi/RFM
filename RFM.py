...
st.write("*User need to input excel invoice file and choose appropriate columns.Sample file (xlsx) & Field selection (jpg) can be found in github repo https://github.com/gacloudi/RFM.")
